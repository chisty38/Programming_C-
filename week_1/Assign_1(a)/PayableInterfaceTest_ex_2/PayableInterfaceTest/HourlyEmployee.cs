...
public class HourlyEmployee : Employee, IPayable
{
   ...
   // calculate earnings; override Employee’s abstract method Earnings and provide implementation GetPaymentAmount()
   public new decimal GetPaymentAmount()
   {
   ...
   public override string ToString() =>
    ...
    //override employees earnings method
